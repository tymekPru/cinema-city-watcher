...
def main() -> None:
    parser = argparse.ArgumentParser(description="Watcher biletów Cinema City (lokalnie)")
    parser.add_argument("--once", action="store_true", help="jeden przebieg i koniec")
    parser.add_argument("--interval", type=float, default=60, help="sekundy między przebiegami")
